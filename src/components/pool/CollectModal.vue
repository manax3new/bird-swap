    ...
    >
        <div>
            <div v-if="isCompoundPool" class="flex-center align-items-center">
                <el-button-group>
                    <el-button type="primary" @click="data.shouldCompound = true" :plain="!data.shouldCompound"
                               style="margin-right: 10px;">Compound
                    </el-button>
                    <el-button type="primary" @click="data.shouldCompound = false" :plain="data.shouldCompound">
                        Harvest
                    </el-button>
                </el-button-group>
            ...
            <div class="flex justify-content-space-between">
                <div>
                   <strong> {{ data.shouldCompound ? 'Compounding' : 'Harvesting'}}:</strong>
                </div>
                <div>
            ...
            <div>
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-button @click="confirm" :disabled="data.pendingTx" class="custom-button-100percent"
                                   type="primary">
