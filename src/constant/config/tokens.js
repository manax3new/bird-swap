...
export const mainnetTokens = {
    ...
    bird: new Token(
        MAINNET,
        '0x2DF197b65F2e79cc8934839DE0B94A205d77C9E4',
        18,
        'BIRD',
        'Birdswap Token',
...
export const testnetTokens = {
    ...
    syrup: new Token(
        TESTNET,
        '0x2741E01B1d73e9bE75a52aa1fAC7DAf931de14A9',
        18,
        'SYRUP',
        'SyrupBar Token',
        'https://birdswap.finance/',
    ),
    bake: new Token(
        TESTNET,
        '0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5',
    ...
    qsd: new Token(
        TESTNET,
        '0xc8E8F35DA18a397cDD196fD4E7a8A5655F9bC1AD',
        18,
        'QSD',
        'QIAN second generation dollar',
        'https://chemix.io/home',
...
const tokens = () => {
    ...
    if (parseInt(chainId.value, 10) === ChainId.TESTNET) {
...
export const getConstantTokens = () => {
    
    const Web3Connect = useWeb3Connect()
    const chainId = Web3Connect.chainId

    if(parseInt(chainId.value) === ChainId.TESTNET) {
